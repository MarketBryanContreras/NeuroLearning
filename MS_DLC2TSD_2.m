function [pos, behav] = MS_DLC2TSD_2(dir_in, model_in,conv_fac, plot_flag)
...
%So far this-field contains a row per file and a coloum for each point-type (filed) tracked in DLC make an empty field for each.
