...
%   Inputs:
%            -hypno[struct]: Structure containing the data and labels ofr sleep states. Obtained from "dSub_Sleep_screener" from the CEH2 repository 
% 
% 
%   Outputs:
...
%% Format data to work with it in this function
...
jmps_1=diff(hypno.data==1); % Binarize data where 1 was presnet and calculate difference to mark beginnings(1) and ends of states (-1)
